...
def validate_fields():
    ...
    if not username_error and not pw1_error and not pw2_error and not email_error and not pw1empty_error and not pw2empty_error:
        return render_template('hello_greeting.html', username = username)

    else:
        return render_template('hello_form.html', username_error=username_error, pw1_error=pw1_error, pw2empty_error=pw2empty_error, pw1empty_error=pw1empty_error, pw2_error=pw2_error, email_error=email_error,
